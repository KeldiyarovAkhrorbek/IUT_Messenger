...
import com.projects.iutmessenger.databinding.FragmentEditUserBinding
...
class EditUserFragment : Fragment() {
    ...
    private lateinit var roleSpinnerAdapter: ArrayAdapter<String>
    ...
    override fun onCreateView(
        ...
        roleList.add("admin")
        roleSpinnerAdapter = ArrayAdapter<String>(
            requireContext(),
            android.R.layout.simple_list_item_1,
            roleList
        )
        binding.spinner.adapter = groupSpinnerAdapter
        binding.spinnerRole.adapter = roleSpinnerAdapter
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                binding.apply {
                    ...
                    if (student.role == "admin") {
                        binding.spinnerRole.setSelection(2)
    ...
    private fun isValid(): Boolean {
        ...
        val role = roleList[binding.spinnerRole.selectedItemPosition]
